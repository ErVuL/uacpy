...
_EXPORTS = {
    ...
    'transfer_function_from_impulse_response': 'system',
    'arrival_transfer_function': 'system',
    'broadband_propagation_loss': 'system',
    'gate_transfer_function': 'system',
    'tone_phasor': 'estimate',
    'waveform_spectrum_at': 'estimate',
    'simulate_arrival_reception': 'system',
    'uniform_frequency_step': 'system',
    'ChannelRegime': 'system',
    'COHERENCE_BANDWIDTH_FACTORS': 'system',
    'rms_delay_spread': 'system',
    'energy_support': 'system',
    'coherence_bandwidth': 'system',
    'coherence_factor': 'system',
    'channel_regime': 'system',
...
__all__ = [
    ...
    "transfer_function_from_impulse_response", "channel_response",
    "arrival_transfer_function", "broadband_propagation_loss",
    "gate_transfer_function", "uniform_frequency_step",
    "tone_phasor", "waveform_spectrum_at",
    "simulate_arrival_reception",
    "ChannelRegime", "COHERENCE_BANDWIDTH_FACTORS", "rms_delay_spread", "energy_support",
    "coherence_bandwidth", "coherence_factor", "channel_regime",
