...
def scenario_a_wind_shipping():
    ...
    plt.savefig(OUTPUT_DIR / 'example_09a_wind_shipping.png', dpi=150, bbox_inches='tight')
    plt.close()

    print(f"  ✓ Generated: {OUTPUT_DIR / 'example_09a_wind_shipping.png'}")
...
def scenario_b_multiple_sources():
    ...
    plt.savefig(OUTPUT_DIR / 'example_09b_multiple_sources.png', dpi=150, bbox_inches='tight')
    plt.close()

    print("  ✓ Generated: output/example_09b_multiple_sources.png")
...
def scenario_c_wind_model_comparison():
    ...
    plt.tight_layout()
    plt.savefig(OUTPUT_DIR / 'example_09c_wind_models.png', dpi=150, bbox_inches='tight')
    plt.close()

    print(f"  ✓ Generated: output/example_09c_wind_models.png")
...
def scenario_d_deep_vs_shallow():
    ...
    plt.tight_layout()
    plt.savefig(OUTPUT_DIR / 'example_09d_deep_shallow.png', dpi=150, bbox_inches='tight')
    plt.close()

    print("  ✓ Generated: output/example_09d_deep_shallow.png")
